    ...
    <section className="mx-auto max-w-[1280px] px-4 pt-8">
      ...
      <div className="flex flex-wrap gap-2">
        {tiles.map((t) => (
          ...
          >
            <div className="relative size-12 overflow-hidden rounded-xl border border-border-subtle bg-white transition-shadow group-hover:shadow-md sm:size-14">
              <Image
                src={`/icons/${t.slug}.png`}
                alt={t.name}
                fill
                sizes="56px"
