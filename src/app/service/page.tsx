...
export const metadata = {
  ...
  description:
    "BathHub цахим худалдааны вэб сайтын үйлчилгээний нөхцөл, хэрэглэгчийн эрх үүрэг.",
};
    ...
    <main className="mx-auto max-w-3xl px-4 py-10 pb-16">
      ...
      <div className="mb-8 flex flex-col gap-3">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed border-l-2 border-brand pl-4">
          Та <strong>bathhub.mn</strong>-д нэвтрэх болон худалдан авалт хийхдээ
